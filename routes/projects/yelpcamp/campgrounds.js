...
router.get("/", function(req,res){
    ...
    Campground.find({}, function(err, allCampgrounds){
       if(err){
           ...
           res.render("projects/yelpcamp/campgrounds/index", {campgroundsEJS: allCampgrounds, currentUser: req.user, page: 'campgrounds'});
       }
    });
...
router.get("/new", middleware.isLoggedIn, function(req, res){
    res.render("projects/yelpcamp/campgrounds/new");
})
...
router.get("/:id", function(req, res){
    ...
    Campground.findById(req.params.id).populate("comments").exec(function(err, foundCampground){
        if(err || !foundCampground){
            ...
            // render show template with that campground
            res.render("projects/yelpcamp/campgrounds/show", {campground: foundCampground, mapAPI: process.env.MAPS_API_KEY});
        }
    });
});
...
router.get("/:id/edit", middleware.checkCampgroundOwnership, function(req, res){
    Campground.findById(req.params.id, function(err, foundCampground){
            res.render("projects/yelpcamp/campgrounds/edit", {campground: foundCampground});
    });
});
